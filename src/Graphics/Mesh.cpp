...
void Mesh::Init()   {
    ...
    physicsProperties.acceleration = glm::vec3(0, 1, 0);
}
...
void Mesh::Update(float dt) {
    ...
    this->physicsProperties.velocity += this->physicsProperties.acceleration*dt;
    this->transform.position += this->physicsProperties.velocity*dt;
